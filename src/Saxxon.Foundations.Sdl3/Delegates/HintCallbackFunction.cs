...
/// </param>
[PublicAPI]
public sealed unsafe class HintCallbackFunction(
    HintCallbackFunction.Del func
) : IDisposable
{
    /// <summary>
    ...
    /// </summary>
    internal static delegate* unmanaged[Cdecl]<IntPtr, byte*, byte*, byte*, void> Callback =>
        &Ingress;
