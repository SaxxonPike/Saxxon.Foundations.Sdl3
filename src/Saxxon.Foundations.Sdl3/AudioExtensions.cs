...
{
    /// <summary>
    /// Extensions for <see cref="MIX_Audio"/>.
    /// </summary>
    extension(MIX_Audio)
    {
        /// <summary>
        ...
        public static unsafe IntPtr<MIX_Audio> CreateSineWave(
            ...
            int hz,
            float amplitude
        ) => ((IntPtr<MIX_Audio>)MIX_CreateSineWaveAudio(mixer, hz, amplitude))
            .AssertSdlNotNull();
        ...
        public static long FramesToMs(
            int sampleRate,
            long frames
        ) => MIX_FramesToMS(sampleRate, frames);
        ...
        public static unsafe IntPtr<MIX_Audio> LoadIo(
            ...
            bool preDecode,
            bool closeIo
        ) => ((IntPtr<MIX_Audio>)MIX_LoadAudio_IO(mixer, stream, preDecode, closeIo))
            .AssertSdlNotNull();
        ...
        ) => ((IntPtr<MIX_Audio>)MIX_LoadAudioWithProperties(props))
            .AssertSdlNotNull();
    ...
    /// <summary>
    /// Extensions for <see cref="MIX_Audio"/> references.
    /// </summary>
    extension(IntPtr<MIX_Audio> audio)
    {
        /// <summary>
        /// Converts sample frames to milliseconds.
        /// </summary>
        ...
        /// Milliseconds equivalent.
        /// </returns>
        public unsafe long FramesToMs(
            long frames
        ) => MIX_AudioFramesToMS(audio, frames);
        ...
        /// Sample frames equivalent.
        /// </returns>
        public unsafe long MsToFrames(
            long ms
        ) => MIX_AudioMSToFrames(audio, ms);
